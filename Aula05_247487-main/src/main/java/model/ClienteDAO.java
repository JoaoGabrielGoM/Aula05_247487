...
// CRUD    
    ...
    private Cliente buildObject(ResultSet rs) {
        ...
        try {
            cliente = new Cliente(rs.getInt("id"), rs.getString("nome_cli"), rs.getInt("tel_cli"), rs.getString("end_cli"));
    ...
    public void update(Cliente cliente) {
        try {
            ...
            stmt.setInt(2, cliente.getTel_cli());
