...
public class Consulta {
    ...
    private int sint_consul;
    private int num_sess_consul;

    public Consulta(int num_consul, int data_consul, int hor_consul, int sint_consul, int num_sess_consul) {
        this.num_consul = num_consul;
    ...
    public int getSint_consul() {
        return sint_consul;
    }

    public void setSint_consul(int sint_consul) {
        this.sint_consul = sint_consul;
    }
